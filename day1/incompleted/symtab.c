...
Type* duplicateType(Type* type) {
    ...
    if (newType == NULL) {
        fprintf(stderr, "Memory allocation failed in duplicateType\n");
        exit(EXIT_FAILURE);
    }
    ...
    switch (type->typeClass) {
        ...
        case TP_ARRAY:
            ...
            break;
        default:
            fprintf(stderr, "Unknown type class in duplicateType\n");
            free(newType);
            return NULL;
    }
    return newType;
...
Object* createTypeObject(char *name) {
 Object* typ = (Object*) malloc(sizeof(Object));
    ...
    typ->typeAttrs->actualType = NULL;
    return typ;
}

Object* createVariableObject(char *name) {
   Object* varial = (Object*) malloc(sizeof(Object));
    strcpy(varial->name, name);
    varial->kind = OBJ_VARIABLE;
    varial->varAttrs = (VariableAttributes*) malloc(sizeof(VariableAttributes));
    varial->varAttrs->type = NULL;
    varial->varAttrs->scope = symtab->currentScope;
    return varial;
}
